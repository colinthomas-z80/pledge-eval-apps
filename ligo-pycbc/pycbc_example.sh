...
python match_strain.py --input-file data/H1_strain_1.hdf5 --channel H1 --output-file H1_5-10_1.csv --template-range 8-10 --template-step 1.0
python match_strain.py --input-file data/L1_strain_1.hdf5 --channel L1 --output-file L1_5-10_1.csv --template-range 8-10 --template-step 1.0
